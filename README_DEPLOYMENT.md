...
## V2.1 Fix
The public index page no longer shows an Admin/Score link. Public pages load `public.js`, which does not include commissioner credentials. Admin tools live at `admin.html` and load `admin.js`.
